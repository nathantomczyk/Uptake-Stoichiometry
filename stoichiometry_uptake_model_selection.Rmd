...
model<-lm(n.uptake~chla+(1|treatment.year/stream),data=n.uptake[n.uptake$iteration==i,])
...
past.optimal.model<-glm(uptake.binary~fungi+chla+corrected.flow+temp+light+added.NP,data=n2[n2$iteration==i,],na.action = na.fail,family=binomial)
...
model.fit<-data.frame(chla.coef=rep(NA,1000),flow.coef=rep(NA,1000),np.coef=rep(NA,1000),light.coef=rep(NA,1000),r.squared.m=rep(NA,1000),r.squared.c=rep(NA,1000))
for (i in 1:1000){
  
model<-glmer(uptake.binary~chla+corrected.flow+light+added.NP+(1|treatment.year/stream),data=n2[n2$iteration==i,],na.action = na.fail,family=binomial)
n.uptake.model<-summary(model)
...
model.fit<-data.frame(chla.coef=rep(NA,1000),light.coef=rep(NA,1000),r.squared.m=rep(NA,1000),r.squared.c=rep(NA,1000))
for (i in 1:1000){
  
model<-glmer(uptake.binary~chla+light+(1|treatment.year/stream),data=n2[n2$iteration==i,],na.action = na.fail,family=binomial)
n.uptake.model<-summary(model)
...
model.fit<-data.frame(chla.coef=rep(NA,1000),flow.coef=rep(NA,1000),r.squared.m=rep(NA,1000),r.squared.c=rep(NA,1000))
for (i in 1:1000){
...
model.fit<-data.frame(chla.coef=rep(NA,1000),flow.coef=rep(NA,1000),np.coef=rep(NA,1000),r.squared.m=rep(NA,1000),r.squared.c=rep(NA,1000))
for (i in 1:1000){
  
model<-glmer(uptake.binary~chla+corrected.flow+added.NP+(1|treatment.year/stream),data=n2[n2$iteration==i,],na.action = na.fail,family=binomial)
n.uptake.model<-summary(model)
